    ...
    return (
        ...
        <div className="container border rounded mt-2">
            ...
            <div className="row" id='card-core'>
                ...
                <div className="col-sm-8 col-md-6 m-2">
                    <Cartao cabecalho="20/04/2021">
                        <Pedido icone="fas fa-book fa-2x" titulo="Livro"
            ...
            <div className="row" id='card-core'>
                ...
                <div className="col-sm-8 col-md-6 m-2">
                    <Cartao cabecalho="23/01/2021">
                        <Pedido icone="fas fa-mouse fa-2x" titulo="Mouse"
                            descricao="Mouse Bluetooth 8000 DPI - Logitech" />
                        {componenteFeedback}
                    </Cartao>
                </div>
            </div>
